        ...
        <div class="card mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a class="btn btn-dark" href="{{ route('vacacion.indexEmpleado') }}">Nuevo</a>
                </div>
            </div>
        </div>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                generateButton.addEventListener("click", function() {
                    ...
                    if (selectedFormat === "pdf") {
                        ...
                        XLSX.writeFile(data, "reporte de Vacaciones.xlsx");
                    }
                });
            });
        </script>
                ...
                <div class="card">
                    <div class="card-body">
                        {{-- <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a class="btn btn-dark ml-auto" href="{{ route('vacacion.indexEmpleado') }}">Nuevo </a>
                        </div> --}}
                                    ...
                                    @foreach ($vacaciones as $vacacion)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'route' => ['vacaciones.destroy', $vacacion->id],
