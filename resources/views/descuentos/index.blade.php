    ...
    <div class="content-wrapper">
        <div class="card mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
                <h1 class="card-title">DESCUENTOS</h1>
                <div>
                    <a class="btn btn-success ml-2" href="#" id="generateReport">Reporte</a>
                    <a class="btn btn-dark" href="{{ route('descuento.indexEmpleado') }}">Nuevo</a>
                </div>
            </div>
        </div>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                generateButton.addEventListener("click", function() {
                    ...
                    if (selectedFormat === "pdf") {
                            ...
                            content: [{
                                ...
                                },
                                {
                                    table: {
                                        ...
                                        body: [
                                            ["ID", "Nombres", "Apellidos", "Fecha", "Hora", "Monto", "Estado", 
                                            ],
                                            @foreach ($descuentos as $descuento)
                                                ["{{ $descuento->id }}",
                                                    "{{ $descuento->Nombre }}",
                        ...
                        XLSX.writeFile(data, "reporte de Descuentos.xlsx");
                    }
                });
            });
        </script>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($descuento->estado != 2)
                                                    ...
                                                    {!! Form::open([
                                                        'method' => 'DELETE',
                                                        'route' => ['descuentos.destroy', $descuento->id],
                                                        'style' => 'display:inline',
                                                    ]) !!}
                                                    {!! Form::submit('Anular', ['class' => 'btn btn-danger']) !!}
                                                    {!! Form::close() !!}
                                                @endif
                                                <a class="btn btn-success" href="{{ route('descuentos.show', $descuento->id) }}">Ver
                                                    detalle</a>
                                            </td>
                                        </tr>
                                    @endforeach
