        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                function generatePDF() {
                    const logoPath =
                    '{{ asset('admin/assets/images/logo.png') }}'; // Ruta del logo (ruta pública de Laravel).
                                    ...
                                    body: [
                                        ...
                                        @foreach ($empleadosConCargo as $empleados)
                                            ["{{ $empleados->id }}", "{{ $empleados->Nombre }}",
                                                "{{ $empleados->Apellido }}", "{{ $empleados->Email }}",
                                                "{{ $empleados->Celular }}", "{{ $empleados->Cargo }}"
                                            ],
                                        @endforeach
                                    ],
                                },
                            ...
                            <div class="text-center">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a class="btn btn-primary mx-2"
                                        href="{{ route('empleados.edit', $empleados->id) }}">Editar</a>
                                    {!! Form::open([
                                        'method' => 'DELETE',
                                        'route' => ['empleados.destroy', $empleados->id],
