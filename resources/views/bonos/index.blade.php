    ...
    <div class="content-wrapper">
        <div class="card mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
                <h1 class="card-title">BONOS</h1>
                <div>
                    <a class="btn btn-success ml-2" href="#" id="generateReport">Reporte</a>
                    <a class="btn btn-dark" href="{{ route('bono.indexEmpleado') }}">Nuevo</a>
                </div>
            </div>
        </div>
                                            ...
                                            <td>
                                                ...
                                                @if ($bono->estado != 2)
                                                    <a class="btn btn-primary"
                                                        href="{{ route('bonos.edit', $bono->id) }}">Editar</a>
                                                    {!! Form::open([
                                                        'method' => 'DELETE',
                                                        'route' => ['bonos.destroy', $bono->id],
                                                        'style' => 'display:inline',
                                                    ]) !!}
                                                    {!! Form::submit('Anular', ['class' => 'btn btn-danger']) !!}
                                                    {!! Form::close() !!}
                                                @endif
                                                <a class="btn btn-success" href="{{ route('bonos.show', $bono->id) }}">Ver
                                                    detalle</a>
                                            </td>
                                        </tr>
                                    @endforeach
