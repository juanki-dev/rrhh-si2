        ...
        <div class="card mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a class="btn btn-dark" href="{{ route('permiso.indexEmpleado') }}">Nuevo</a>
                </div>
            </div>
        </div>
            ...
            <tbody>
                @foreach ($permisos as $permiso)
                    <tr>
                        ...
                        <td>{{ date('d-m-Y', strtotime($permiso->fecha)) }}</td>
                        <td>{{ date('d-m-Y', strtotime($permiso->fechaInicio)) }}</td>
                        <td>{{ date('d-m-Y', strtotime($permiso->fechaFin)) }}</td>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                generateButton.addEventListener("click", function() {
                    ...
                    if (selectedFormat === "pdf") {
                            ...
                            content: [{
                                ...
                                },
                                {
                                    table: {
                                        ...
                                        body: [
                                            ["ID", "Nombres", "Apellidos", "Fecha", "Fecha Inicio",
                                                "Fecha Fin",
                                                "Descripcion",
                                            ],
                                            @foreach ($permisos as $permiso)
                        ...
                        XLSX.writeFile(data, "reporte de Permisos.xlsx");
                    }
                });
            });
        </script>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary"
                                                    href="{{ route('permisos.edit', $permiso->id) }}">Editar</a>
                                                {!! Form::open([
                                                    'method' => 'DELETE',
